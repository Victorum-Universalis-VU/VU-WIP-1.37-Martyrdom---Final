...
NGame = {
	...
	MERC_COMPANIES_PER_RNW_REGION = 8, 		-- auto-generated merc companies per region in RNW
...
NDiplomacy = {
	...
	CALL_TO_ARMS_COST = 20,							-- Cost in favors to call ally to arms when you're not promising them territory
	FAVORS_LAND_DIVIDER = 4,						-- How many favors do you get for giving other countries land? (divider on development)
	...
	MARCH_BASE_DEVELOPMENT_CAP = 400, 				-- Countries with more total development than this cannot be made into a march
	...
	PO_TRANSFER_VASSAL_AE = 0.1,
	PO_ANNEX_PRESTIGE = 0.50, 						-- _DDEF_PO_ANNEX_PRESTIGE = 10, (No effect on loser :)
	PO_DEMAND_PROVINCES_PRESTIGE = 0.2, 			-- _DDEF_PO_DEMAND_PROVINCES_PRESTIGE = 10, (Per development)
	...
	PO_RETURN_CORES_PRESTIGE = 0.1, 				-- (Per development)
	PO_RELEASE_VASSAL_PRESTIGE = 0.1, 				-- _DDEF_PO_RELEASE_VASSAL_PRESTIGE = 10,
	PO_TRANSFER_VASSAL_PRESTIGE = 0.1,
	PO_RELEASE_ANNEXED_PRESTIGE = 0.1, 				-- _DDEF_PO_RELEASE_ANNEXED_PRESTIGE = 10, (Per released province)
	PO_CHANGE_RELIGION_PRESTIGE = 0.2, 				-- _DDEF_PO_CHANGE_RELIGION_PRESTIGE = 10,
	PO_FORM_PU_PRESTIGE = 0.1, 						-- _DDEF_PO_FORM_PU_PRESTIGE = 10,
	PO_BECOME_VASSAL_PRESTIGE = 0.1, 				-- _DDEF_PO_BECOME_VASSAL_PRESTIGE = 10,
	...
	PO_TRADE_POWER_PRESTIGE = 5,
	PO_CONCEDE_COLONIAL_PRESTIGE = 1,
	PO_GIVE_UP_CLAIM_PRESTIGE = 1,
	...
	PO_ENFORCE_FLEET_BASING_PRESTIGE = 10,
	PO_ENFORCE_MIL_ACCESS_PRESTIGE = 10,
	PO_WAR_REPARATIONS_PRESTIGE = 10,
	PO_END_RIVALRY_PRESTIGE = 20,

	PEACE_COST_PRIMITIVE_NERF = 0.5,				-- war score cost multiplier vs primitives
	PEACE_COST_DEMAND_PROVINCE = 0.2,				-- Decreased this to 0.4 from 0.5 Demand a province (scales by province wealth, also used for annex)
	PEACE_COST_CONCEDE_PROVINCE = 0.2,				-- Demand colonial area province concession.
	...
	PEACE_COST_REVOKE_CORE = 0.15,					-- Revoke a core (scales by province wealth)
	...
	PEACE_COST_ANNUL = 5, 							-- _DDEF_PEACE_COST_ANNUL_ Peace cost for annulment of treaties
	...
	PEACE_COST_STEER_TRADE = 30,					-- Peace cost for steering trade
	PEACE_COST_INDEPENDANCE = 15, 					-- Peace cost for breaking free of union
	PEACE_COST_ENFORCED_FLEET_BASING_RIGHTS = 5,    -- Peace cost for enforced fleet basing righs
	PEACE_COST_ENFORCED_MILITARY_ACCESS = 5,        -- Peace cost for enforced military access
	...
	DIP_PORT_FEES = 0.04,							-- DIP_PORT_FEES
	...
	MONTHS_BEFORE_TOTAL_OCCUPATION = 24,			-- Before this many months have passed in the war, you cannot gain 100% warscore by just occupying the warleader
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_TRIBUTARY_DEV = 0.075,		-- Yearly change of Mandate for each hundred development tributary state.
	...
	IMPERIAL_CITY_IA = 0.003,								-- Monthly per imperial free city
	...
	TRIBUTE_BASE_ADM = 0.015,						-- Tributary State: Part Adm tribute, mulitplied by total development
	TRIBUTE_BASE_DIP = 0.015,						-- Tributary State: Part Dip tribute, mulitplied by total development
	TRIBUTE_BASE_MIL = 0.015,						-- Tributary State: Base Mil tribute, mulitplied by total development
...
NCountry = {
	...
	EXPLOIT_ADM_INCOME = 30,	-- months of income
	EXPLOIT_DIP_SAILORS = 3,
	EXPLOIT_MIL_MANPOWER = 3,
	EXPLOIT_COOLDOWN_MONTHS = 120,
	...
	ABDICATE_RULING_LENGTH_THRESHOLD = 10,
	...
	INSTITUTION_BONUS_FROM_IMP_DEVELOPMENT = 7.5, -- Increased this to 7.5 from 5 (increased this from 5 to 7.5. Orig value is 2.5 on EUIV vanilla by SF)
	...
	CORRUPTION_COST = 0.025,						-- cost for monthly combat per development
	STATE_MAINTENANCE_DEV_FACTOR = 0.003,		-- per dev
	...
	CULTURAL_UNION_MIN_DEV = 2000,				-- Minimum development to get cultural union effect without Common Sense, or if CULTURAL_UNION_MIN_RANK is set to negative value.
	...
	MIN_DEV_FOR_FREE_CITY = 20,					-- Capital must have at least this much development to be a free city
	...
	MIN_DEVELOPMENT_FOR_GOV_RANK_2 = 500,		-- Need at least this much development to upgrade to government rank 2
	MIN_DEVELOPMENT_FOR_GOV_RANK_3 = 2000,		-- Need at least this much development to upgrade to government rank 3
	...
	ADDITIONAL_MIN_DEVELOPMENT_FOR_GOV_RANK_X = 3000,	-- ADDITIONAL development needed to upgrade to government rank above 3
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.0025,			-- yearly increase in price in percent,
	...
	CULTURE_MIN_DEVELOPMENT_TO_PROMOTE = 40,		-- Minimum development required to promote the culture.
	...
	PS_BUY_EXPLORER = 50,
	PS_ASSAULT = 10,
	PS_ARTILLERY_BARRAGE = 30,		-- 30 mil points to barrage fort with arty (keep in mind all the ingame discount modifiers)
	...
	PS_IMPROVE_PROVINCE_CAPITAL_DISCOUNT = 0.10,
	...
	PROVOKE_REVOLT_SIZE_FACTOR = 0.3, -- Extra strength of revolt when using provoke revolt
	PROVOKE_REVOLT_MIN_PROGRESS = 50.0,	-- Minimum revolt progress to use provoke
	UNREST_DECAY = 1.0,

	PROMOTE_MERCANTILISM_INCREASE = 2,
	...
	MAX_QUEEN_AGE = 50,								-- You can't get a queen/prince older than this
	...
	MONTHS_TO_CORE_MAXIMUM = 120,					-- Maximum amount of months it will take to core a province after all modifiers.
	...
	REBEL_ARTILLERY_INCREASE_LEVEL_2_TECH = 33,		-- Tech level at which REBEL_ARTILLERY_INCREASE_LEVEL_2_SIZE is applied
	...
	GRANT_PROVINCE_LIBERTY_MULTIPLIER = 0.25,
	...
	HORDE_UNITY_PER_RAZE = 0.25,						-- Horde unity gained per development level razed.
	DEVOTION_PER_RAZE = 0.33,						-- Devotion gained per development level razed.
	PILLAGE_CAPITAL_MAX_DEV_PILLAGED = 2,
	NATIVE_UPRISING_COOLDOWN_MONTHS = 60,
	...
	SETTLMENT_GROWTH_CHANCE_MULTIPLIER = 5.0, -- Affects chance of development increase per year if a colonist is working on Settlement Growth.
	SETTLMENT_GROWTH_CHANCE_MIN = 0.02, -- Minimum chance of increasing development for colonists promoting Settlement Growth
...
NEconomy = {
	...
	GOLD_MINE_DEPLETION_THRESHOLD = 2,				-- Gold mines above production level or above can be depleted
	GOLD_MINE_DEPLETION_CHANCE = 0.05,					-- Chance of gold mine being depleted (yearly, per production above threshold)
	...
	LAND_TECH_MAINTENANCE_IMPACT = 0.0175, 			-- % each tech increases it.
	NAVAL_TECH_MAINTENANCE_IMPACT = 0.0175, 			-- % each tech increases it.
	LAND_TECH_MERC_MAINTENANCE_IMPACT = 0.04, 			-- % each tech increases it.
	...
	MINIMUM_INTERESTS = 0.2,						-- _EDEF_MINIMUM_INTERESTS_
	...
	MISSIONARY_MAINTENANCE_AUTONOMY_FACTOR = 0.5,		-- How much this is ncreased from local autonomy
	MISSIONARY_MAINTENANCE_AUTONOMY_BASE = 1.0,			-- The local autonomy is added to this base in the formula.
	MISSIONARY_MAINTENANCE_DEVELOPMENT_CAP = 60,		-- Where dev will get capped by the system for calculations.
	...
	MISSIONARY_TIME_BASE = 700,						-- _EDEF_MISSIONARY_TIME_BASE = 10,
	...
	EXPELLED_MINORITY_DEV_BONUS_FACTOR = 0.1,		-- Bonus development on minority expulsion completion, multiplied by origin province development
	EXPELLING_MINORITY_COLONIST_COST_FACTOR =  0.5,	-- Colonist maintenance cost factor when expelling minority
	EXPELLING_MINORITY_SETTLER_CHANCE_FACTOR = 0.003,	-- Settler chance bonus when expelling minority, multiplied by origin province development
...
NMilitary = {
	...
	FORT_PER_DEV_RATIO = 33,						-- 1 non-obsolete maintained fort per this amount of development = +1 AT
	...
	BASE_MP_TO_MANPOWER = 0.125,		            -- 250 men per manpower
	SIEGE_ATTRITION = 1,
	...
	ASSAULT_DEFENDER_LOSS = 0.1, 					-- _MDEF_ASSAULT_DEFENDER_LOSS = 10,
	...
	BASE_COMBAT_WIDTH = 12.0,						-- _MDEF_BASE_COMBAT_WIDTH_
	MAX_COMBAT_WIDTH = 40,
	...
	NAVAL_SUPPLY_RANGE = 50, 						-- Supply range for ships.
	...
	RESERVE_DAILY_MORALE_DAMAGE = 0.03,				-- Reserve troops take this fraction of their maximum morale as damage (modified by reserves_organisation)
	...
	MINIMUM_DRILL_DECAY_MODIFIER = -25, -- Change this to a negative value so values below -100% drill decay will actually give drill
	MINIMUM_MERCENARY_HIRE_PRICE = 0.05, -- Lower cap for mercenary cost modifier, change it to 0 for free mercs
...
NAI = {
	...
	ACCEPTABLE_BALANCE_MULT_FRIEND_IN_COMBAT = 0.75,
	...
	MAX_CAV_PERCENTAGE = 30, -- For modding, actual ratio is dynamically computed but will be no higher than this.
	...
	FORT_MAINTENANCE_CHEAT = 0, -- Set to 1 to enable or set to 0 to disable. AI fort maintenance cheating. Was once active in vanilla, but no longer
	...
	DIPLOMATIC_ACTION_MILITARY_ACCESS_ENEMY_REGIMENTS_FACTOR = 20.0, -- AI scoring for military access is increased by this for each enemy regiment they are sheltering
 	DIPLOMATIC_ACTION_VASSALIZE_DEVELOPMENT_FACTOR = 10, -- AI scoring for vassalize is increased by this for each development in target's provinces
	DIPLOMATIC_ACTION_ANNEX_DEVELOPMENT_FACTOR = 25, -- AI scoring for demand annexation is increased by this for each development in target's provinces
	DIPLOMATIC_ACTION_INTEGRATE_DEVELOPMENT_FACTOR = 25, -- AI scoring for integrate is increased by this for each development in target's provinces
	...
	DIPLOMATIC_ACTION_CRUSADE_DEVELOPMENT_FACTOR = 0.5, -- AI scoring for crusade is increased by this for each development in target's provinces
	...
	DIPLOMATIC_ACTION_CLAIM_THRONE_DEVELOPMENT_FACTOR = 0.5, -- AI scoring for claim throne is increased by this for each development in target's provinces
	...
	DIPLOMATIC_ACTION_SUPPORT_HEIR_DEVELOPMENT_FACTOR = 1, -- AI scoring for support heir is increased by this for each development in target's provinces
	...
	AI_TOTAL_DEV_CULTURE_MULTIPLIER = 5,				-- Multiplier for how much the AI values having much development in accepted cultures.
	...
	DIPLOMATIC_ACTION_TRIBUTARY_ACCEPTANCE_PER_DEVELOPMENT = -0.25,	-- AI scoring for accepting becoming a tributary state per raw development
	...
	CHARTER_COMPANY_DEVELOPMENT_RELUCTANCE_MULTIPLIER = 1,	-- How much development multiplied by to provide resistance
	...
	IMPORANT_PROVINCE_THRESHOLD = 0.02,							-- AI will try to defend provinces under threat worth more than this percentage of total development
	...
	ESTATE_MAX_PRIVILEGES = 2, -- Also see ESTATE_PRIVILEGES_MAX_CONCURRENT in NCountry
	...
	MIN_DAYS_AFTER_TRUCE_ENDS = 0, -- How long AI needs to wait after a truce ends to declare a war, some time needed for the player to take any action since AI can do it immediately
},
...
NAIEconomy = {
	...
	LOAN_REPAYMENT_SAVINGS_PRIORITY = 0.7,				-- Per loan
	LOAN_REPAYMENT_SAVINGS_PRIORITY_WARTIME = 0.4,		-- Per loan
...
NGraphics = {
	...
	AGGRESSIVE_EXPANSION_RED_G = 0.25,
...
NFrontend = {
	CAMERA_LOOKAT_X = 2787.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1845.0,
	CAMERA_LOOKAT_SETTINGS_X = 2787.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1845.0,
	CAMERA_START_X = 2787.0,						-- Initial position in main menu
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 1755.0,
	CAMERA_END_X = 2787.0,							-- Move to position in main menu
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 1700.0,
	...
	FRONTEND_POS_X = 2787.0,
	FRONTEND_POS_Y = 900.0,
	FRONTEND_POS_Z = 1825.0,
	FRONTEND_LOOK_X = 2787.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 1845.0,

	SETTINGS_POS_X = 2787.0,
	SETTINGS_POS_Y = 551.0,
	SETTINGS_POS_Z = 1228.0,
	SETTINGS_LOOK_X = 2787.0,
	SETTINGS_LOOK_Y = 0.0,
	SETTINGS_LOOK_Z = 1499.0,

	MP_OPTIONS_POS_X = 2787.0,
	MP_OPTIONS_POS_Y = 922.0,
	MP_OPTIONS_POS_Z = 1398.0,
	MP_OPTIONS_LOOK_X = 2787.0,
	MP_OPTIONS_LOOK_Y = 0.0,
	MP_OPTIONS_LOOK_Z = 1459.0,

	TUTORIAL_POS_X = 2724.0,
	TUTORIAL_POS_Y = 124.0,
	TUTORIAL_POS_Z = 1654.0,
	TUTORIAL_LOOK_X = 2710.0,
	TUTORIAL_LOOK_Y = 21.0,
	TUTORIAL_LOOK_Z = 1792.0,

	CONTENT_POS_X = 2787.0,
	CONTENT_POS_Y = 922.0,
	CONTENT_POS_Z = 1642.0,
	CONTENT_LOOK_X = 2787.0,
	CONTENT_LOOK_Y = 0.0,
	CONTENT_LOOK_Z = 1845.0,

	CREDITS_POS_X = 2911.0,
	CREDITS_POS_Y = 231.0,
	CREDITS_POS_Z = 1824.0,
	CREDITS_LOOK_X = 2916.0,
	CREDITS_LOOK_Y = 19.0,
	CREDITS_LOOK_Z = 2027.0,
},
...
NReligion = {
	...
	CONSECRATE_PATRIARCH_THRESHOLD = 60, --in development
	...
	DOOM_REDUCTION_FROM_OCCUPATION = 0.025,					-- Multiplied by development
	...
	MAX_RELIGIOUS_CENTER_SPREAD_DISTANCE = 120.0,				-- When spreading the religion to other provinces the distance wont exceed this number
	...
	MINIMUM_DEVELOPMENT_ALLOWED = 20.0,								-- You will need a higher development than this for your province to be eligible for cardinal
	COUNTRY_DEVELOPMENT_DIVIDER = 400.0,							-- When a cardinal is chosen the formula is diving a countrys development by this number.
	...
	HARMONY_LOSS_PER_DEV_CONVERTED = 0.5,
...
NNationDesigner = {
	...
	BASE_TAX_COST_MODIFIER = 0.25,
	PRODUCTION_COST_MODIFIER = 0.25,
	MANPOWER_COST_MODIFIER = 0.25,
	...
	IDEAS_LEVEL_COST_1 = 1,					-- Can be overriden in script
	IDEAS_LEVEL_COST_2 = 2,
	IDEAS_LEVEL_COST_3 = 3,
	IDEAS_LEVEL_COST_4 = 4,
	IDEAS_LEVEL_COST_5 = 5,
	IDEAS_LEVEL_COST_6 = 6,
	IDEAS_LEVEL_COST_7 = 7,
	IDEAS_LEVEL_COST_8 = 8,
	IDEAS_LEVEL_COST_9 = 9,
	IDEAS_LEVEL_COST_10 = 10,
	IDEAS_MAX_LEVEL = 8,					-- Can be overriden in script
